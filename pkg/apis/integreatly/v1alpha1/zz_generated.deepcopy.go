...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GrafanaPlaylistList) DeepCopyInto(out *GrafanaPlaylistList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GrafanaPlaylistList.
func (in *GrafanaPlaylistList) DeepCopy() *GrafanaPlaylistList {
	if in == nil {
		return nil
	}
	out := new(GrafanaPlaylistList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *GrafanaPlaylistList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
